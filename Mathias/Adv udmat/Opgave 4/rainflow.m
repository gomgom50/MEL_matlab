...
% - residual cycles are treated by duplicating the signal and 
%   re-running the algorithm, thus closing all cycles.
%
%
...
function S = remove_duplicated_values(S)
% scan signal for duplicated values and remove

    n = length(S);
    duplicates = false(n,1);
